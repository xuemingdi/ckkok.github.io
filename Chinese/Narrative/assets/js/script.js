...
function showHideAvailability() {
	if(m1 === true){
		...
		document.getElementById("Menu1").style.background = "url('assets/images/Menu/01.png')";
	}
	else{
	...
	if(m2 === true){
		...
		document.getElementById("Menu2").style.background = "url('assets/images/Menu/02.png')";
	}
	else{
	...
	if(m3 === true){
		...
		document.getElementById("Menu3").style.background = "url('assets/images/Menu/03.png')";
	}
	else{
		document.getElementById("Menu3").style.pointerEvents = "none";
	}
	if(m4 === true){
		document.getElementById("Menu4").style.pointerEvents = "auto";
		document.getElementById("Menu4").style.background = "url('assets/images/Menu/04.png')";
	}
	else{
		document.getElementById("Menu4").style.pointerEvents = "none";
	}
	if(m5 === true){
		document.getElementById("Menu5").style.pointerEvents = "auto";
		document.getElementById("Menu5").style.background = "url('assets/images/Menu/05.png')";
	}
	else{
		document.getElementById("Menu5").style.pointerEvents = "none";
	}
	if(m6 === true){
		document.getElementById("Menu6").style.pointerEvents = "auto";
		document.getElementById("Menu6").style.background = "url('assets/images/Menu/06.png')";
	}
	else{
		document.getElementById("Menu6").style.pointerEvents = "none";
	}
}
