...
function createGUI(scene) {
    ...
    var toLoad = [
        ...
        {name: 'instruction_active', src: 'img/new_instruction-heat.png'},
        ...
        {name: 'hotplate_off', src: 'img/btn_hotplate_off.png'},
        {name: 'hotplate_on', src: 'img/btn_hotplate_on.png'},
        {name: 'btnprev', src: 'img/btn_prev.png'},
        {name: 'reset_btn', src: 'img/reset_btn.png'},
        {name: 'title_heating', src: 'img/title_heating.png'}
    ];
    ...
    loader.onFinish = function () {
        setTimeout(function () {
            ...
            var title_heating = new bGUI.GUIPanel('title_heating', assets['title_heating'], null, gui);
            title_heating.relativePosition(new BABYLON.Vector3(0.50, 0.90, 0));
            ...
            function onGas() {
				...
				title_heating.mesh.isVisible = true;
            ...
            function onHoton() {
                ...
                title_heating.mesh.isVisible = false;

                heatcool = 1;               // Cooling loop enabled
                hotoff.setVisible(true);
                hoton.setVisible(false);
            }

            var hotoff = new bGUI.GUIPanel('hoton', assets['hotplate_off'], null, gui);
            ...
            function onHotoff() {
                ...
                switch (state) {
                    case 0:
                        ...
                        scene.getPhysicsEngine().setGravity(new BABYLON.Vector3(0,-3,0)); // Low gravity shows more like gas - it's a cheat
                        break;
                    case 1:
                        graph_width = 510;
                        graph_height = 280;
                ...
                //
                if(!doneFirstOn){
                     transitionSolidToLiquidPerformed = false;
                    transitionLiquidToGasPerformed = false;
                    transitionSolidToLiquidCounter = 0;
                    transitionLiquidToGasCounter = 0;
                    lowered_top_flow_collider_for_solid_sim = false;
                    switched_off_flow_colliders_for_solid_sim = false;
                    re_raised_top_flow_collider_for_solid_sim = false;
                    //
                    sim_finished = false;
                }
               

                heatcool = 0;                   // Heating enabled
